...
$bancoDePalavrasFile = 'palavra02.txt';
$palavra = "";
...
if ($_SESSION['erros'] >= 6) {
    header('Location: perdeu2.php');
} elseif (implode("", $_SESSION['palavraOculta']) == $palavra) {
    header('Location: entrenivel02.php');
    session_destroy();
} else {
...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="estilo/nivel02.css">
    </head>
    ...
    <body>
        ...
        <main>
            <div class="metade">
                ...
                echo '<img class="robozin" src="imagem/robozin_n2_01-05.svg" alt="">';
                ?>

                <?php 
                if($_SESSION['erros'] >1 && $_SESSION['erros'] <= 3)
                echo '<img class="robozin" src="imagem/robozin_n2_02-05.svg" alt="">';
                ?>

                <?php 
                if($_SESSION['erros'] >3 && $_SESSION['erros'] <= 6)
                echo '<img class="robozin" src="imagem/robozin_n2_03-05.svg" alt="">';
                ?>
            </div>
            ...
            <div class="metade02">
                <div class="caixa1">
                    ...
                    <br>
                    <div class="relogio">
                    <p id="tempoRestante">Tempo restante: <span id="contador">45</span> segundos</p>
                    </div>
                </div> <!-- caixa01 -->
            </div> <!-- metade02  -->
        ...
        <script>
          var tempoRestante = 45; // Tempo inicial em segundos
