...
$bancoDePalavrasFile = 'palavra03.txt';
$palavra = "";
...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="estilo/nivel03.css">
    </head>
    ...
    <body>
        ...
        <main>
            <div class="metade">
                ...
                echo '<img class="robozin" src="imagem/robozin_n3_01.png" alt="">';
                ?>

                <?php 
                if($_SESSION['erros'] >1 && $_SESSION['erros'] <= 3)
                echo '<img class="robozin" src="imagem/robozin_n3_02.png" alt="">';
                ?>

                <?php 
                if($_SESSION['erros'] >3 && $_SESSION['erros'] <= 6)
                echo '<img class="robozin" src="imagem/robozin_n3_03.png" alt="">';
                ?>
            </div>
            ...
            <div class="metade02">
                <div class="caixa1">
                    ...
                    <br>
                    <div class="relogio">
                    <p id="tempoRestante">Tempo restante: <span id="contador">20</span> segundos</p>
                    </div>
                </div> <!-- caixa01 -->
            </div> <!-- metade02  -->
